function dealOfTheDay() {
    ...
    var countDownDate = new Date("september 30, 2021 13:35:00").getTime();
    ...
    var x = setInterval(() => {
        ...
        document.getElementById('demo1').innerHTML = hours + "hr ";
        document.getElementById('demo2').innerHTML = minutes + "min ";
        document.getElementById('demo3').innerHTML = seconds + "sec ";
